...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const message = {
        ...
        success: 'Спасибо! Мы вам позвоним в ближайшее время.',
        fail: 'Oops, error....'
    };
    ...
    function calcTotal() {
        if(!sex || !height || !weight || !age || !ratio) {
            ...
            document.querySelector('#kkal').textContent = 'Введите ВСЕ данные';          
            return;
        } else {
            document.querySelector('#kkal').textContent = '  ккал';
